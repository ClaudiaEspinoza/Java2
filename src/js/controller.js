...
import {showImagen } from "./imagen";
import { showFooter } from "./footer";
import SearchView from './allviews/search';
...
const loadRecipe = async id => {
  ...
  try {
    ...
    recipeContainer.insertAdjacentHTML('afterbegin', showFooter(recipe));
    ...
    recipeContainer.insertAdjacentHTML('afterbegin', showImagen(recipe));
  } catch (error) {
